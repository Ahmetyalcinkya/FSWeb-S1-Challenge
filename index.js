...
function profilListesi(fenomenler) {
  const yeniFenomenler = [...fenomenler];
...
console.log(fenomenGonderimSayisi(fenomenler, "Cristiano Ronaldo"));
...
function platformaGoreCokGonderiYapanFenomen(dizi, platform) {
  ...
  for (let i = 0; i < dizi.length; i++) {
    if (dizi[i].platform === platform) {
      ...
      // const maxNumber = dizi.posts.reduce(
